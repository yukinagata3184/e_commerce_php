# テーブル定義書 author:nagata
|論理テーブル名|商品マスタ|
|:---:|:---:|
|物理テーブル名|m_product|

|論理カラム名|物理カラム名|データ型|サイズ|属性|PK|FK|A_I|参照テーブル|NOT NULL|
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
...
|会員ID|member_id|VARCHAR|64| | | | | |〇|
|パスワード|member_password|VARCHAR|255| | | | | |〇|
|氏名|member_name|VARCHAR|100| | | | | |〇|
|メールアドレス|member_email|VARCHAR|100| | | | | |〇|
|電話番号|member_tel|VARCHAR|15| | | | | |〇|
|郵便番号|member_zip_code|VARCHAR|8| | | | | |〇|
...
|性別ID|gender_id|TINYINT|-|UNSIGNED| | | | | |
...
|購入者ID|customer_id|INT|-|UNSIGNED| |〇| | |〇|
...
|論理カラム名|物理カラム名|データ型|サイズ|属性|PK|FK|A_I|参照テーブル|NOT NULL|
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
|季節ID|product_season_id|INT|-|UNSIGNED|〇| |〇| |〇|
...
|会員コード|member_cd|INT|-|UNSIGNED| |〇| |m_member| |
...
|論理カラム名|物理カラム名|データ型|サイズ|属性|PK|FK|A_I|参照テーブル|NOT NULL|
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
|会員コード|member_cd|INT|-|UNSIGNED|〇|〇| |m_member|〇|
